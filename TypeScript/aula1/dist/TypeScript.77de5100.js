...
function redirecionar(usuario) {
  if (usuario.cargo === "gerente" || usuario.cargo === "coordenador" || usuario.cargo === "supervisor") {
...
var MeuCachorro = /*#__PURE__*/_createClass(function MeuCachorro(nome, idade, parqueFavorito) {
  _classCallCheck(this, MeuCachorro);
...
var cao = new MeuCachorro("Apolo", 14, "Bosque");
console.log(cao.nome);
console.log(cao.parqueFavorito);
console.log(cao.idade); //importar uma biblioteca
